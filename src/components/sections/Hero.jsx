...
const Hero = () => {
  ...
  return (
      <section
          id="home"
          ref={sectionRef}
          className="relative min-h-screen flex items-center overflow-hidden bg-[#030712] pt-32 pb-20 lg:pt-40 lg:pb-0"
      >
        {/* ── Grid Background ── */}
        <GridBackground />
        ...
        <motion.div
            ...
            style={{
              background:
                  "radial-gradient(circle, rgba(141,255,105,0.08) 0%, transparent 70%)",
            }}
